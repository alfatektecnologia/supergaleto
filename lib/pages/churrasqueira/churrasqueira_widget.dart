...
class ChurrasqueiraWidget extends StatefulWidget {
  const ChurrasqueiraWidget({super.key});

  @override
  State<ChurrasqueiraWidget> createState() => _ChurrasqueiraWidgetState();
}

class _ChurrasqueiraWidgetState extends State<ChurrasqueiraWidget>
    with TickerProviderStateMixin {
  late ChurrasqueiraModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChurrasqueiraModel());
                                      ...
                                      child: StreamBuilder<List<PedidosRecord>>(
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          return ListView.builder(
                                            ...
                                            shrinkWrap: true,
                                            scrollDirection: Axis.vertical,
                                            itemCount: listViewPedidosRecordList
                                                .length,
                                            itemBuilder:
